...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ps_digital_clock.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../ps_digital_clock.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../ps_digital_clock.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../ps_digital_clock.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../ps_digital_clock.srcs/sources_1/bd/system/ip/system_processing_system7_0_3" \
