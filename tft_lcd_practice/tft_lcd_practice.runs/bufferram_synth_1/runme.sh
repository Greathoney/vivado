...
HD_PWD='C:/Users/thyoo/vivado/tft_lcd_practice/tft_lcd_practice.runs/bufferram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bufferram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bufferram.tcl
