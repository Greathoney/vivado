...
HD_PWD='C:/Users/thyoo/vivado/ps_textlcd/ps_textlcd.runs/system_textlcd_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_textlcd_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_textlcd_0_2.tcl
